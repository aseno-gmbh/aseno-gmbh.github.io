  ...
  return (
    <div className="w-full">
      ...
      >
          ...
          {/* <div className="w-full"> */}
          <div className="w-full border-b border-body-color border-opacity-10 pb-8 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-10 dark:text-white">
