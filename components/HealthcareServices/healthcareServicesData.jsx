const healthcareServicesData = [
  {
    ...
    title: "Gematik-Integration & FHIR-Einführung",
    paragraph:
      "Wir unterstützen bei der Einführung von FHIR und der Anbindung an die Gematik-Infrastruktur.",
  },
  {
    id: 2,
    icon: (
    ...
    title: "IHE-Profile einführen",
    paragraph: "Wir helfen Gesundheitseinrichtungen bei der Einführung von IHE-Profilen.",
  },
  {
    id: 3,
    icon: (
    ...
    title: "Integration medizinischer Geräte",
    paragraph:
      "Wir integrieren medizinische Geräte in bestehende EMR/EHR-Systeme (Krankenhaussoftware).",
  },
  {
    id: 4,
    icon: (
    ...
    title: "EMR/EHR (Krankenhaussoftware)",
    paragraph:
      "Wir implementieren EMR/EHR-Systeme in Krankenhäusern und Kliniken, um deren Arbeitsabläufe zu digitalisieren.",
  },
  {
    id: 5,
    icon: (
    ...
    title: "Implementierungsreife",
    paragraph: "Wir analysieren Healthcare-Software hinsichtlich ihrer Implementierungsreife.",
  },
  {
    id: 6,
    icon: (
    ...
    title: "Investitionstauglichkeit",
    paragraph: "Wir analysieren Healthcare-Software hinsichtlich ihrer Investitionstauglichkeit.",
  },
];
