const servicesData = [
     ...
     },
    {
      ...
      title: "Holistic Efficient Low-Code Implementation",
      paragraph1:
        "Every implementation starts with vendor-independent, strategic IT consulting to ensure seamless integration of the new solution into your existing IT infrastructure, maximizing the overall value for your business.",
      paragraph2: 
        "Our focus is on the smooth and cost-efficient execution of your specific requirements. We develop state-of-the-art applications that are not only future-proof but also modular and flexible, allowing them to dynamically adapt to your business needs. The result: Efficient Low-Code solutions that provide the agility needed to stay competitive in today’s fast-paced market.",
      paragraph3: 
        "Since the introduction of new technologies often poses challenges for teams, we support you beyond implementation with training and workshops. This ensures that your team confidently utilizes the new technologies and overcomes potential uncertainties about change."
    }
    ];
