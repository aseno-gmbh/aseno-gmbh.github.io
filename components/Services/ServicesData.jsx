const servicesData = [
    {
      ...
      paragraph1:
        "Whether you're starting with an initial idea or already have a fully developed concept and need a second expert opinion for its implementation – we provide vendor-independent IT consulting to strategically optimize your entire IT landscape.",
      paragraph2: 
     ...
     },
    {
      ...
      title: "Effectiv Low-Code Implementation",
      paragraph1:
        "We focus on delivering seamless, cost-effective solutions tailored to your needs. Each project begins with vendor-independent, strategic IT consulting to identify the best products for smooth integration into your current infrastructure, maximizing business value and minimizing risks.",
      paragraph2: 
        "Using best-practice software, we implement customized, low-code solutions that are easy to maintain and significantly reducing the need for large IT teams. Our implementations are modular, flexible, and future-ready, dynamically adapting to your evolving business requirements.",
      paragraph3: 
        "To ensure your team’s success, we provide ongoing support with training and workshops, helping them confidently navigate new technologies and embrace change. The result: agile low-code solutions that keep you competitive in a fast-paced market."
    }
    ];
